<script lang="ts">
  ...
  _$logger.debug.TraceLayoutAndPage('/sveltekit/invalidate/+page.svelte', $page.route.id, data);
  ...
  function rerunLoadFunction() {
    ...
    invalidate('/sveltekit/api/random-number');
  ...
  async function rerunLoadFunctionAsync() {
    ...
    await invalidate('/sveltekit/api/random-number');
