...
export const __DEBUG_MSSQL__ = true;
export const __DEBUG_MYSQL__ = true;
export const __DEBUG_MARIADB__ = true;
export const __DEBUG_POSTGRESQL = true;
export const __DEBUG_MONGO__ = true;
export const __DEBUG_REDIS__ = true;
export const __DEBUG_RABBITMQ = true;
export const __DEBUG_HTTP__ = true;
export const __DEBUG_CORS__ = true;
export const __TRACE_MSG__ = true;
export const __TRACE_API__ = true;
*/

let devMode = false;
const httpsEnabled = false; // set to true when using HTTPS with the production server
...
if (import.meta.env.MODE === 'development') {
  ...
  if (process.env.NODE_ENV === 'development') {
    ...
    devMode = false;
    cookieHttpOnly = true;
    cookieSecure = httpsEnabled ? true : false;
  } else {
  ...
  // only for client side, we are just warning the attacker not to waste time
...
export const __DEBUG_LOAD_DATA__ALL_PARAMS__ = __DEBUG__ && true;
