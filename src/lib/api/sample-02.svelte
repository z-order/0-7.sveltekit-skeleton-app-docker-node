<script lang="ts">
  import { RunAPI } from '$lib/api/sample-02';
...
<main>
  <form method="post" on:submit|preventDefault={handleSubmit}>
    <label class="label">
      <span>Username</span>
      <input class="input" name="username" type="text" placeholder="Username for APIs(2)" />
    </label>
    <label class="label">
      <span>Nickname</span>
      <input class="input" name="nickname" type="text" placeholder="Nickname for APIs(2)" />
    </label>
    <label class="label">
      <span>Phone</span>
      <input class="input" name="phone" type="text" placeholder="Phone number for APIs(2)" />
    </label>
    <label class="label">
      <span>Key</span>
      <input class="input" name="key" type="text" placeholder="Key for APIs(2)" />
    </label>
